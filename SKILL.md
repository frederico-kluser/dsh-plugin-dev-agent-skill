...
- Exported package surfaces measured from npm tarballs @deepseek-ai/dsh-host-webserver, @deepseek-ai/dsh-subprocess, @deepseek-ai/dsh-host-frontend-static, @deepseek-ai/cordis — see docs/arquitetura.md and the mirrored types/ provenance headers.
